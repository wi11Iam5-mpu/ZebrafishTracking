...
#
# Example of usage:
# > $python calibrate_intrinsics.py -cs 9 6 -ss 0.935 -if ../weight.py/checkerboard_images/ -it .jpg
#
...
ap.add_argument('-cs', '--checkerboardSize', nargs='+', type=int,
                help='number of squares on the checkerboard. E.g. [9 6] for a checkerboard that is 9 squares long and 6 squares wide.')
